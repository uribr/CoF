...
public class DoubleParameterWatcher implements TextWatcher
{
    private Double mLimiter;
    ...
    public DoubleParameterWatcher(double limiter, String negativeMessage, String aboveLimiterMessage, String exceptionMessage, String finallyMessage, EditText target)
    {
        super();
        mLimiter = limiter;
